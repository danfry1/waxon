...
func TestRenderNowPlayingNilTrack(t *testing.T) {
	...
	got := RenderNowPlaying(nil, "", nil, false, 0, false, npLyrics{}, 80, 40)
	if got == "" {
...
func TestRenderNowPlayingValidTrack(t *testing.T) {
	...
	got := RenderNowPlaying(track, "", nil, false, 0, false, npLyrics{}, 80, 40)
	if got == "" {
...
func TestRenderNowPlayingZeroSize(t *testing.T) {
	...
	got := RenderNowPlaying(nil, "", nil, false, 0, false, npLyrics{}, 0, 0)
	if got != "" {
